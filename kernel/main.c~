...
//	char bufr[rd_bytes];
	...
	while (1) {
		...
		else if (strcmp(rdbuf, "runxxx") == 0)
		{

			XXX(fd_stdin, fd_stdout);
		}
             else if (strcmp(rdbuf, "runzzz") == 0)
		{

			ZZZ(fd_stdin, fd_stdout);
		}
...
void help()
{
	...
	printf("5. runxxx        : Run a small game on this OS\n");
	printf("6. runttt        : Run a small game on this OS\n");
        printf("7. runzzz        : Run a small game on this OS\n");
	printf("==============================================================================\n");		
}
 void report_xin()
  {
...
void fillBox(int n){  
    int xx, yy, num;  
    int testarr[20]={3,2,5,20,13,15,16,19,1,6,11,8,12,4,10,14,17,7,9,18};
...
int XXX(int fd_stdin,int fd_stdout){  
...
int ZZZ(int fd_stdin,int fd_stdout)
{
	int f[4]; //四个1-14的数
	int i,j,m,n;
	int a,b,c; //符号
